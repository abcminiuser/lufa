...
/** \file
 *
 *  Main source file for the WebUSB demo. This file contains the main tasks of the demo and
 ...
 *  of the USB device after enumeration, and configures the WebUSB device endpoints.
 */
