...
#define __HIDREPORTDATA_H__
	...
	/* Public Interface - May be used in end-application: */
		...
		//@{
			...
			#define HID_RI_DESIGNATOR_MINIMUM(DataBits, ...)_HID_RI_ENTRY(HID_RI_TYPE_LOCAL , 0x40, DataBits, __VA_ARGS__)
			#define HID_RI_DESIGNATOR_MAXIMUM(DataBits, ...)_HID_RI_ENTRY(HID_RI_TYPE_LOCAL , 0x50, DataBits, __VA_ARGS__)
		//@}
