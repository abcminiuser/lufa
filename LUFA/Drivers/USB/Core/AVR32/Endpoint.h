...
#define __ENDPOINT_AVR32_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			 ...
			 */
			#define ENDPOINT_DIR_OUT                        (0 << 0)	// TODO

			/** Endpoint data direction mask for \ref Endpoint_ConfigureEndpoint(). This indicates that the endpoint
			 *  should be initialized in the IN direction - i.e. data flows from device to host.
			 */
			#define ENDPOINT_DIR_IN                         (1 << 0) 	// TODO
			//@}
			 ...
			 */
			#define ENDPOINT_BANK_SINGLE                    (0 << 0) 	// TODO
			 ...
			 */
			#define ENDPOINT_BANK_DOUBLE                    (1 << 0)	// TODO
			//@}
			...
			#define ENDPOINT_CONTROLEP                      0
				 ...
				 */
				#define ENDPOINT_CONTROLEP_DEFAULT_SIZE     8	// TODO
			#endif

			/** Endpoint number mask, for masking against endpoint addresses to retrieve the endpoint's
			 *  numerical address in the device.
			 */
			#define ENDPOINT_EPNUM_MASK                     0x07	// TODO

			/** Endpoint direction mask, for masking against endpoint addresses to retrieve the endpoint's
			 *  direction for comparing with the ENDPOINT_DESCRIPTOR_DIR_* masks.
			 */
			#define ENDPOINT_EPDIR_MASK                     0x80	// TODO

			/** Endpoint bank size mask, for masking against endpoint addresses to retrieve the endpoint's
			 *  bank size in the device.
			 */
			#define ENDPOINT_EPSIZE_MASK                    0x7F	// TODO
		...
		/* External Variables: */
			 ...
			 */
			#if (!defined(FIXED_CONTROL_ENDPOINT_SIZE) || defined(__DOXYGEN__))
				extern uint16_t USB_ControlEndpointSize;
			#else
